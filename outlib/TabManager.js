...
TabManager = /*#__PURE__*/function (_React$Component) {_inherits(TabManager, _React$Component);var _super = _createSuper(TabManager);
  function TabManager(props) {var _this2;_classCallCheck(this, TabManager);
    ...
    _this2.highlightDuplicates = _this2.highlightDuplicates.bind(_assertThisInitialized(_this2));
    ...
    _this2.openTabManagerInNewTab = _this2.openTabManagerInNewTab.bind(_assertThisInitialized(_this2));return _this2;
    ...
    function discardTab(tabId) {
      ...
      function _callee6() {var _this5, tabs, i, t;return _regeneratorRuntime().wrap(function _callee6$(_context6) {while (1) {switch (_context6.prev = _context6.next) {case 0:
                ...
                t && t.length > 1)) {_context6.next = 19;break;}_context6.next = 19;return (
                  browser.tabs.update(t[1].id, { pinned: !t[0].pinned }));case 19:case "end":return _context6.stop();}}}, _callee6, this);}));function pinTabs() {return _pinTabs.apply(this, arguments);}return pinTabs;}() }, { key: "highlightDuplicates", value:



    function highlightDuplicates(e) {
