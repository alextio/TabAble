...
Tab = /*#__PURE__*/function (_React$Component) {_inherits(Tab, _React$Component);var _super = _createSuper(Tab);
  function Tab(props) {var _this;_classCallCheck(this, Tab);
    ...
    function onMouseDown(e) {
      ...
      function _callee(e) {var tabId, windowId, activeTab, activeWindow;return _regeneratorRuntime().wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:if (
                ...
                this.props.middleClick(tabId);_context.next = 21;break;case 9:if (!(
                ...
                }_context.next = 21;break;case 14:_context.next = 16;return (




                  browser.tabs.update(tabId, { active: true }));case 16:activeTab = _context.sent;_context.next = 19;return (
                  browser.windows.update(windowId, { focused: true }));case 19:activeWindow = _context.sent;
                console.log("".concat(activeWindow.id, ", ").concat(activeTab.id, " clicked"));case 21:return _context.abrupt("return",

                false);case 22:case "end":return _context.stop();}}}, _callee, this);}));function click(_x) {return _click.apply(this, arguments);}return click;}() }, { key: "dragStart", value:
